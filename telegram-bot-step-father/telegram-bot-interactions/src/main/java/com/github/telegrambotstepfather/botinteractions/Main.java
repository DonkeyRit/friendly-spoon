...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Cache cache = new FileCache("/Users/dimaalekseev/Reps/friendly-spoon/telegram-bot-step-father/telegram-bot-interactions/target/cache.ch");
...
// Find and interact with the phone input field
    ...
    private static void openSpecificChat(Page page, ConsoleLogger logger){
        ...
        page.fill("#column-left > div > div > div.sidebar-header.can-have-forum > div.input-search > input", "@WhaleBot Pumps");
    ...
    private static List<String> readMessages(Page page)
    {
        ...
        List<ElementHandle> messageElements = page.querySelectorAll(".bubbles-group .message");
