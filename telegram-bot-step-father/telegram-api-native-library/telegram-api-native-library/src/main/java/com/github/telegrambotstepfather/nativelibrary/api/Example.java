...
//
package com.github.telegrambotstepfather.nativelibrary.api;
...
public final class Example {
     ...
     */
        ...
        MediatorService mediator= new DefaultMediatorService(); 
        TelegramNativeLibraryClient client = new DefaultTelegramNativeLibraryClient(mediator);

        Supplier<TdlibParametersContext> provideTelegramLibraryParameters = () ->  {
            return new TdlibParametersContext(94575, "a3406de8d171bb422bb6ddf3bbd800e2");
        };
    
        Supplier<PhoneNumberContext> providPhoneNumber = () -> {
            return new PhoneNumberContext("381628120111");
        };
    
        Supplier<AuthorizationCodeContext> provideAuthorizationCode = () -> {
        ...
        mediator.registerHandler(
            ...
            new AuthorizationHandler<TdlibParametersContext>(client, provideTelegramLibraryParameters));
        mediator.registerHandler(
            TelegramNativeLibraryEvent.WAIT_PHONE_NUMBER, 
            new AuthorizationHandler<PhoneNumberContext>(client, providPhoneNumber));
        mediator.registerHandler(
            TelegramNativeLibraryEvent.WAIT_AUTHORIZATION_CODE, 
            new AuthorizationHandler<AuthorizationCodeContext>(client, provideAuthorizationCode));
        client.initialize();
