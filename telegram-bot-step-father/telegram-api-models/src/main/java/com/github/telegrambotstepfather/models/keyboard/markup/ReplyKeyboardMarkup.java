...
import com.github.telegrambotstepfather.models.keyboard.buttons.simple.KeyboardButton;
...
public record ReplyKeyboardMarkup(
     ...
     */
    @JsonProperty(value = "inputFieldPlaceholder")
    Optional<Boolean> inputFieldPlaceholder,
    /**
