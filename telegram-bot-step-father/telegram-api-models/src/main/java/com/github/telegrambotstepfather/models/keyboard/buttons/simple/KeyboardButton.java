package com.github.telegrambotstepfather.models.keyboard.buttons.simple;
...
public record KeyboardButton(
    ...
    Optional<KeyboardButtonRequestUser> requestUser,
    /**
     * If specified, pressing the button will open a list of suitable chats. Tapping on a chat will send its identifier to the bot in a “chat_shared” service message. Available in private chats only.
     */
    @JsonProperty(value = "request_chat")
    Optional<KeyboardButtonRequestChat> requestChat,
    /**
